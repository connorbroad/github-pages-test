...
<div
    ...
    <div class="p-6">
        <p class="text-text-secondary mt-0 mb-4 leading-relaxed">
            Export all your Solo RPG data to a file or import data from another device.
        </p>
    ...
    <div class="border-border-primary border-t p-6">
        <div class="mb-4 flex items-center gap-3">
            <div>
                <h3 class="m-0 text-lg font-semibold text-(--text-primary)">Game Blueprints</h3>
                <p class="m-0 text-sm text-(--text-secondary)">Export and import game blueprints</p>
            </div>
        </div>
