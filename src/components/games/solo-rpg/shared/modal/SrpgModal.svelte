...
{#if show}
    <div
        ...
        <div
            ...
            {#if showBackButton}
                <button
                    class="hover:text-text-primary absolute top-2 left-2 cursor-pointer border-none bg-transparent p-2 text-2xl transition-all duration-200 hover:scale-110 active:scale-95"
                    on:click={handleBack}
                    aria-label="Go back">
                    ←
                </button>
            ...
            {#if showCloseButton}
                <button
                    class="hover:text-text-primary absolute top-2 right-2 cursor-pointer border-none bg-transparent p-2 text-2xl transition-all duration-200 hover:scale-110 active:scale-95"
